...
namespace GeoApp
{
    public class FormCirculo : Form
    {
        ...
        private Button btnCalcular = new Button { Text = "Calcular", Location = new Point(100, 50) };

        public FormCirculo()
        {
            this.Text = "Cálculo de Círculo";
            this.Controls.Add(new Label { Text = "Radio:", Location = new Point(20, 20) });
            this.Controls.Add(txtRadio);
            this.Controls.Add(btnCalcular);

            btnCalcular.Click += (s, e) => {
                double res = Calculadora.AreaCirculo(double.Parse(txtRadio.Text));
